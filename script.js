...
const toolProducts = [
  {
    category: "Seguridad",
    name: "Máscara de soldar fotosensible",
    detail: "Con diseño, embalaje 20 und",
    price: "$10.000 + IVA",
    image: "assets/images/pdf-extract/tools-p04-05.jpg",
    items: ["Protección personal", "Precio por unidad"],
  },
  {
    category: "Seguridad",
    name: "Protector facial",
    detail: "Visor transparente",
    price: "$1.000 + IVA",
    image: "assets/images/pdf-extract/tools-p04-06.jpg",
    items: ["Protección personal", "Precio por unidad"],
  },
  {
    category: "Seguridad",
    name: "Casco de seguridad amarillo",
    detail: "Color amarillo",
    price: "$500",
    image: "assets/images/pdf-extract/tools-p05-02.jpg",
    items: ["Protección personal", "Precio por unidad"],
  },
  {
    category: "Seguridad",
    name: "Casco de seguridad rojo",
    detail: "Color rojo",
    price: "$750",
    image: "assets/images/pdf-extract/tools-p05-02.jpg",
    items: ["Protección personal", "Precio por unidad"],
  ...
  {
    category: "Bisagras",
    name: "Bisagra 65 x 60 x 2,5",
    detail: "Bisagra metálica",
    price: "$310",
    image: "assets/images/pdf-extract/tools-p08-05.jpg",
    items: ["Precio por unidad", "Foto referencial del catálogo"],
  },
  {
    category: "Bisagras",
    name: "Bisagra 70 x 55 x 3,0",
    detail: "Bisagra metálica",
    price: "$350",
    image: "assets/images/pdf-extract/tools-p08-05.jpg",
    items: ["Precio por unidad", "Foto referencial del catálogo"],
  ...
  {
    category: "Bisagras",
    name: "Bisagra 1.10 x 1.05 x 5,0",
    detail: "Bisagra metálica",
    price: "$1.500",
    image: "assets/images/pdf-extract/tools-p08-05.jpg",
    items: ["Precio por unidad", "Foto referencial del catálogo"],
  ...
  {
    category: "Bisagras",
    name: "Bisagra 1.25 x 1.25 x 5,0",
    detail: "Bisagra metálica",
    price: "$2.100",
    image: "assets/images/pdf-extract/tools-p08-05.jpg",
    items: ["Precio por unidad", "Foto referencial del catálogo"],
  ...
  {
    category: "Bisagras",
    name: "Bisagra 1.50 x 1.30 x 5,0",
    detail: "Bisagra metálica",
    price: "$2.950",
    image: "assets/images/pdf-extract/tools-p08-05.jpg",
    items: ["Precio por unidad", "Foto referencial del catálogo"],
...
const glassProducts = [
  {
    ...
    detail: "Codigo 8001",
    price: "$16.200 + IVA",
    image: "assets/images/pdf-extract/glass-p01-02.jpg",
  ...
  },
  {
    ...
    detail: "Codigo 8002",
    price: "$12.500 + IVA",
    image: "assets/images/pdf-extract/glass-p01-03.jpg",
    items: ["Espesor 50 mm", "Rendimiento 14.4 m2", "Ancho 1.2 m x largo 12 m"],
  },
  {
    category: "Paneles",
    ...
    detail: "Codigo 8003",
    price: "$9.870 + IVA",
    image: "assets/images/pdf-extract/glass-p01-01.jpg",
  ...
  },
  {
    ...
    detail: "Codigo 8004",
    price: "$11.440 + IVA",
    image: "assets/images/pdf-extract/glass-p01-04.jpg",
...
const screwImageRules = [
  ...
  {
    src: "assets/images/screws/pdf-product-p4-08.png",
...
const salePopupClose = document.querySelector(".sale-popup-close");
...
function showView(viewName, options = {}) {
  const nextView = validViews.has(viewName) ? viewName : "inicio";
  ...
  viewTriggers.forEach((trigger) => {
    trigger.classList.toggle("active", trigger.dataset.viewTarget === nextView);
  });

  if (!options.silentHash && window.location.hash.slice(1) !== nextView) {
...
function buildProductCard(product) {
  ...
  body.append(category, title, detail);
  ...
  body.append(buildSpecList(product.items));
  card.append(body);
  return card;
}
...
viewTriggers.forEach((trigger) => {
  trigger.addEventListener("click", (event) => {
    const viewName = trigger.dataset.viewTarget;
    if (!viewName) return;
...
window.addEventListener("hashchange", () => {
  ...
  if (validViews.has(hashView)) {
    showView(hashView, { silentHash: true, instant: true });
  }
});

showView(window.location.hash.slice(1) || "inicio", { silentHash: true, instant: true });

window.setTimeout(() => {
  if (!window.matchMedia("(prefers-reduced-motion: reduce)").matches) {
    salePopup.hidden = false;
